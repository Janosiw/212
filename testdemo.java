...
public class testdemo {
       ...
       public static void main(String[] args) {
        ...
        // Welcome Message
        System.out.println("\n****************************************");
        System.out.println("*Welcome to Photo Manager (linked list)   *");
        System.out.println("****************************************\n");
        ...
        // Creating Albums
        Album album1 = new Album("Album1", "bear", manager, null);
        Album album2 = new Album("Album2", "animal AND grass", manager, null);
        Album album3 = new Album("Album3", "", manager, null);
        ...
        LinkedList<Photo> photos1 = album1.getPhotosLinkedListOnly();
        ...
        LinkedList<Photo> photos2 = album2.getPhotosLinkedListOnly();
        ...
        LinkedList<Photo> photos3 = album3.getPhotosLinkedListOnly();
        ...
        System.out.println("\n***** Get album3 name, condition, and photos (After Deletion) *****");
        System.out.println("album3 name: " + album3.getName());
        System.out.println("album3 condition: " + album3.getCondition());
        System.out.println();

        LinkedList<Photo> photosAfterDeletion = album3.getPhotosLinkedListOnly();
